...
def save_realtime_pose_data_and_jitter_report(
    ...
    filtered_pose_path = output_folder / f"{prefix}_one_euro_pose.npy"
            ...
            writer.writerow(
                {
                    ...
                    "one_euro_total_jitter": filtered_total,
                    "one_euro_valid_landmark_transitions": filtered_transition_count,
